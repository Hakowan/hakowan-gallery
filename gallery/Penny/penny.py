...
l0 = base.channel(material=hkw.material.RoughConductor("Cu"))
...
l1 = base.channel(
    material=hkw.material.Principled(
        color=hkw.texture.ScalarField("normal", colormap="identity"),
    )
)
...
l2 = base.channel(
    material=hkw.material.Principled(
        color=hkw.texture.ScalarField("depth", colormap=[0, 1])
    ),
)
...
l3 = base.channel(
    material=hkw.material.Principled(color=hkw.texture.ScalarField("depth")),
)
